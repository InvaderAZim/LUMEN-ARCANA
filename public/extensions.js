...
document.addEventListener('click',e=>{
  ...
  if(el.id==='xClear'){e.preventDefault();if(confirm('Очистити локальні дані LUMEN ARCANA?')){[HKEY,FKEY,NKEY,PKEY,'la_compatibility','la_tarot_type','la_mode','la_sound_enabled','la_sound_volume'].forEach(k=>localStorage.removeItem(k));location.reload()}return}
