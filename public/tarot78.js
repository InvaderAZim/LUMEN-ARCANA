...
const RWS_SUIT_PREFIX={wands:'Wands',cups:'Cups',swords:'Swords',pentacles:'Pents'};
const rwsUrl=(file,width=420)=>`https://commons.wikimedia.org/wiki/Special:Redirect/file/${encodeURIComponent(file)}?width=${width}`;
const cardImage78=(group,index)=>group==='major'
 ? rwsUrl(RWS_MAJOR_FILES[index],420)
 : rwsUrl(`${RWS_SUIT_PREFIX[group]}${String(index+1).padStart(2,'0')}.jpg`,420);
